    ...
    return (
      <View style={styles.socialTags}>
        ...
        <View style={[styles.row, styles.tagInputContainer]}>
          <TextInput autoCorrect={false} autoCapitalize="none" onSubmitEditing={this.handleCreateTag} onChangeText={customTag => this.setState({ customTag })} value={this.state.customTag} style={styles.tagInput} placeholder="Add your own tag!" />
